...
const setGoalsForm = router.get('/setGoals', (req, res)=>{
  res.sendFile('C:/Users/Antoine/healthNut/api/views/setGoals.html');
});

const setGoals = router.post('/setGoals', (req, res)=>{
